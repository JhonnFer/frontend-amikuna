...
import useEventosEstudiante from "./useEventosEstudiante";
import useAsistenciaEvento from "./useAsistenciaEvento";
...
const useDashboardState = () => {
  ...
  const { eventos, loading: loadingEventos, obtenerEventos } = useEventosEstudiante();
  const { confirmarAsistencia, rechazarAsistencia, cargando: cargandoAsistencia } = useAsistenciaEvento(obtenerEventos);
  ...
  const [fotosAEliminar, setFotosAEliminar] = useState([]); // ← array
