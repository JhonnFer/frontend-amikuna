...
>
  ...
  <div className="relative w-full flex-[5]">
    <img
      ...
      alt="perfil"
      className="w-[9] h-auto object-cover  top-0"
    />
    <button
  ...
  <div className="flex flex-col flex-[4] justify-between p-3 text-center overflow-hidden">
    <div className="flex flex-col gap-0.5 overflow-hidden">
      ...
      <p className="text-xs text-gray-500 truncate">
        {usuarioActual.ubicacion?.ciudad}, {usuarioActual.ubicacion?.pais}
      </p>
      ...
      <p className="text-xs text-gray-700">
        Género: <span className="font-medium">{usuarioActual.genero}</span>
      </p>

      <p className="text-xs text-gray-700">
        Orientación: <span className="font-medium">{usuarioActual.orientacion}</span>
      </p>
